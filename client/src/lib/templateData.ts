...
const MNEMONIC_REFERENCES: Record<string, MnemonicReferenceByStyle> = {
  ...
  h1: {
    homophone: [
      "1789 →『一起扒舊』：法國人民一起扒掉舊王朝",
      "一七八九 →『一起罷舊』：罷掉舊制度，攻進巴士底",
      "1789 →『一起罷舊』：攻佔巴士底、推翻波旁王朝，訴求自由平等博愛",
    ],
    rhyme: [
      "一七八九法國吼，巴士底獄被攻破",
      "國王椅子坐不久，人民怒火把王冠踢下樓",
      "一七八九巴士底破，波旁王朝倒，自由平等博愛起",
    ],
    meme: [
      "法國人民：日子過不下去。巴士底監獄：怎麼大家都來我家？",
      "波旁王朝：應該還穩吧？1789：系統通知，你的王位已停止支援。",
      "考題版：1789 攻佔巴士底、推翻波旁王朝，口號是自由平等博愛。",
    ],
    "story-chain": [
      "巴—王—自：攻巴士底、倒王朝、喊自由",
      "人民餓肚子 → 巴士底變成闖關入口 → 王冠一路滾出宮殿",
      "事件鏈：1789 攻巴士底 → 推翻波旁王朝 → 自由平等博愛",
    ],
  },
  h2: {
    homophone: [
  ...
  h3: {
    homophone: [
      ...
      "1517 →『一屋議題』：馬丁路德發表九十五條論綱，挑戰贖罪券制度",
    ],
    rhyme: [
      "一五一七論綱貼，贖罪券制被挑戰",
      "別人抱怨寫一點，路德九十五條貼滿整面牆邊",
      "一五一七路德貼，九十五條反贖罪券，宗教改革掀改變",
    ],
    meme: [
      "教會：買券就安心。馬丁路德：我有 95 個問題。",
      "別人發一篇抱怨文；馬丁路德直接上傳九十五集長篇連載。",
      "考題版：1517 馬丁路德發表九十五條論綱，挑戰贖罪券制度。",
    ],
    "story-chain": [
      "馬—九—贖：馬丁路德、九十五條、挑戰贖罪券",
      "贖罪券開店 → 路德抱來九十五張意見單 → 改革大門被敲到打開",
      "事件鏈：1517 贖罪券爭議 → 九十五條論綱 → 宗教改革",
    ],
  },
  h4: {
    homophone: [
      ...
      "1929 →『一跌餓久』：華爾街股市崩盤，引發全球經濟蕭條",
    ],
    rhyme: [
      "一九二九股市落，黑色星期全球縮",
      "股票溜滑梯不停，錢包跟工作一起跌到找不清",
      "一九二九華爾街崩，黑色星期四後全球經濟蕭條",
    ],
    meme: [
      "華爾街：只是跌一下。全球經濟：我先躺很多年。",
      "1929 投資人的螢幕：沒有當機，只是數字集體跳樓。",
      "考題版：1929 黑色星期四，華爾街股市崩盤並引發全球蕭條。",
    ],
    "story-chain": [
      "華—崩—蕭：華爾街、股市崩盤、全球蕭條",
      "股價坐溜滑梯 → 銀行關水龍頭 → 失業像骨牌一路倒遍全球",
      "事件鏈：1929 華爾街崩盤 → 銀行緊縮與失業 → 全球蕭條",
    ],
  },
  h5: {
    homophone: [
  ...
  c2: {
    homophone: [
      ...
      "He 氦 →『很輕』：輕的惰性氣體、不易反應，吸入後聲音會變高",
    ],
    rhyme: [
      "氦氣輕，性情靜，吸入之後聲音高",
      "氦坐氣球飛上天，拒絕反應還拿麥克風唱超高音",
      "He 氦氣輕又安定，是惰性氣體，不易反應、吸入聲音高",
    ],
    meme: [
      "其他元素：來反應啊！氦：不了，我是惰性氣體。",
      "元素派對忙配對；氦坐角落搭氣球升空：單身才是最高境界。",
      "考題版：He 是輕的惰性氣體，化性安定，吸入後聲音頻率會升高。",
    ],
    "story-chain": [
      "輕—惰—高：氣體輕、性質惰、吸入聲音高",
      "氦拒絕所有反應邀請 → 搭氣球升天 → 拿麥克風唱出尖高音",
      "性質鏈：He 氦 → 輕且惰性 → 不易反應 → 吸入聲音變高",
    ],
  },
  c3: {
    homophone: [
  ...
  c4: {
    homophone: [
      "Cl 氯 →『洗囉』！氯能消毒，卻有刺激氣味",
      "氯 →『綠又嗆』：黃綠色氣體，聞起來很刺激",
      "Cl 氯 →『池裡』：黃綠色刺激性氣體，可用於游泳池消毒",
    ],
    rhyme: [
      "氯氣黃綠味刺鼻，游泳池裡負責洗",
      "氯穿黃綠衣進泳池，細菌嚇到集體辦理退池",
      "Cl 氯是黃綠色刺激性氣體，可消毒，常聯想到游泳池氣味",
    ],
    meme: [
      "細菌：游泳囉！氯：今天泳池由我消毒。",
      "氯一進泳池，細菌群組立刻顯示：全體被管理員強制登出。",
      "考題版：Cl 是黃綠色刺激性氣體，具有消毒作用，常用於泳池。",
    ],
    "story-chain": [
      "黃—刺—消：黃綠色、刺激性、可以消毒",
      "氯穿黃綠制服走進泳池 → 鼻子拉警報 → 細菌拖行李逃跑",
      "性質鏈：Cl 氯 → 黃綠色刺激性氣體 → 消毒殺菌 → 游泳池",
    ],
  },
  c5: {
    homophone: [
