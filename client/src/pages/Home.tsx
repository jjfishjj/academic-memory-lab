      ...
      <div className="container flex items-center justify-between h-16">
        <a href="#top" className="flex items-center gap-2.5">
          ...
          <span className="font-display font-extrabold text-lg tracking-wide">
            記憶手帳社 <span className="text-primary">MemoDesk</span>
          </span>
        </a>
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <Link href="/game">
            <Button
              size="sm"
              className="font-display font-bold rounded-full px-5"
            >
        ...
        <Link href="/game" className="md:hidden">
          <Button size="sm" className="font-display font-bold rounded-full">
            開始任務
          </Button>
        </Link>
      </div>
...
function StatBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full ${color === "yellow" ? "bg-amber-100 text-amber-800" : "bg-pink-100 text-pink-800"}`}
    >
      {label} +{value}
    </span>
  );
  ...
  return (
    <div id="top" className="min-h-screen flex flex-col">
      ...
      <section className="container grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center py-14 lg:py-20">
        <div>
          <p className="font-hand text-2xl text-primary mb-3">
            for campus learners — 學院型態專用
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link href="/game">
              <Button
                size="lg"
                className="font-display font-bold text-base rounded-full px-8 h-12 active:scale-[0.97] transition-transform"
              >
            ...
            <Link href="/periodic-table">
              <Button
                size="lg"
                variant="outline"
                className="font-display font-bold text-base rounded-full px-7 h-12"
              >
            ...
            <Link href="/memgenius">
              <Button
                size="lg"
                variant="outline"
                className="font-display font-bold text-base rounded-full px-7 h-12 border-primary/40 bg-white/70"
              >
        ...
        <div className="relative">
          ...
          <div className="absolute -top-4 -right-3 sticky-note sticky-pink-bg tilt-r px-4 py-3 max-w-[190px] hidden sm:block">
            <p className="font-hand text-lg leading-snug text-pink-900">
              "給公式一點情緒，它就賴著不走了"
            </p>
          </div>
        </div>
      ...
      <section
        id="problem"
        className="py-16 bg-[#F3ECDD]/60 border-y border-border"
      >
        <div className="container">
          <p className="font-hand text-2xl text-primary mb-2">
            the academic struggle
          </p>
          <h2 className="font-display font-extrabold text-3xl mb-10">
            學院學習者的三個死循環
          </h2>
            ...
            {[
              {
                emoji: "🔁",
                title: "背了就忘",
                desc: "考前狂抄十遍，三天後只記得自己抄過十遍。孤立的資訊沒有掛在任何場景上，大腦自然把它當垃圾清掉。",
                tilt: "tilt-l",
              },
              {
                emoji: "😶",
                title: "無感輸入",
                desc: "教科書的知識又平又乾，沒有情緒波動的內容，海馬迴根本懶得標記為「重要」。",
                tilt: "tilt-l2",
              },
              {
                emoji: "🙈",
                title: "假熟練",
                desc: "看著課本覺得都會，蓋起來就一片空白。從沒練過「關掉提示回想」，等於從沒真正提取過記憶。",
                tilt: "tilt-r",
              },
            ].map(p => (
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="paper-card tilt-l relative p-0 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  把詞彙或概念放進一個<b>真實校園場景</b>
                  ——圖書館的還書箱、食堂的微波爐、宿舍上鋪的梯子。
                ...
                <p className="text-xs text-muted-foreground flex items-center gap-1.5">
                  <Clock className="w-3.5 h-3.5" /> 原版 7 分鐘 ·
                  產生一段情境對話 + 一個可回想場景
                </p>
              </div>
            </div>
            ...
            <div className="paper-card tilt-r relative p-0 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-xs text-muted-foreground flex items-center gap-1.5">
                  <Clock className="w-3.5 h-3.5" /> 原版 8 分鐘 · 產生一段故事 +
                  口說/文字複述
                </p>
              </div>
            </div>
      ...
      >
        <div className="container">
          ...
          <h2 className="font-display font-extrabold text-3xl mb-12">
            雙卡記憶任務 · 四步走
          </h2>
            ...
            {[
              {
                ...
                icon: "🎒",
                title: "選學科包",
                desc: "挑官方練習包，或把你自己的單字表、筆記貼進來做成專屬卡包。",
                tilt: "tilt-l",
              },
              {
                n: "02",
                icon: "📍",
                title: "掛進場景",
                desc: "選一個校園角落，或自己寫一個熟悉的地方，把知識點「掛」上去。",
                tilt: "tilt-r",
              },
              {
                n: "03",
                icon: "💗",
                title: "綁上情緒",
                desc: "為知識點選一種情緒，用模板編一句迷你故事，讓杏仁核幫你蓋「重要」章。",
                tilt: "tilt-l2",
              },
              {
                n: "04",
                icon: "🙈",
                title: "遮住回想",
                desc: "關掉所有提示，只靠場景與情緒線索回想。答對蓋章、連擊加分。",
                tilt: "tilt-r",
              },
            ].map((s, i) => (
              <div key={s.n} className={`paper-card ${s.tilt} p-6 relative`}>
                <span className="font-hand text-3xl text-primary/40 absolute top-4 right-5">
                  {s.n}
                </span>
          ...
          <div className="mt-12 flex flex-col items-center gap-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              遊戲全程免登入，能力值與蓋章記錄保存在你的瀏覽器
            </div>
            <Link href="/game">
              <Button
                size="lg"
                className="font-display font-bold text-base rounded-full px-10 h-12 active:scale-[0.97] transition-transform"
              >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Link key={t.path} href={t.path}>
                <div
                  className={`paper-card ${t.tilt} p-6 relative h-full group cursor-pointer`}
                >
                  <span
                    className={`tape-corner ${i % 2 === 0 ? "tape-tl" : "tape-tr"}`}
                  />
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {t.stats.map(s => (
                      <span
                        key={s.t}
                        className={`text-xs font-bold px-2 py-0.5 rounded-full ${s.c}`}
                      >
                        {s.t}
                      </span>
                    ))}
                  </div>
                  <p className="font-hand text-lg text-muted-foreground mb-3">
                    {t.time}
                  </p>
          ...
          <Link href="/train/mrt">
            <div className="paper-card tilt-l p-7 sm:p-9 group cursor-pointer relative overflow-hidden">
              ...
              <div className="grid sm:grid-cols-[auto_1fr_auto] items-center gap-5">
                <span className="w-16 h-16 rounded-full bg-[#0070BD] text-white inline-flex items-center justify-center shadow-md">
                  <TrainFront className="w-8 h-8" />
                </span>
                <div>
                  <p className="font-hand text-xl text-primary">
                    new playable mission
                  </p>
                  <h2 className="font-display font-extrabold text-2xl sm:text-3xl group-hover:text-primary transition-colors">
                    台北捷運全站記憶
                  </h2>
                  <p className="text-muted-foreground mt-2">
                    選一條線，用雙向站卡與前後站補空，把站名、站碼和順序一起記住。
                  </p>
                  <div className="flex flex-wrap gap-2 mt-4 text-xs font-bold">
                    ...
                    <span className="bg-emerald-100 text-emerald-800 rounded-full px-3 py-1">
                      進度自動保存
                    </span>
                  </div>
                </div>
